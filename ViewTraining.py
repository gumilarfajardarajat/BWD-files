...
class ViewTraining:
    def __init__(self,root):
        ...
        self.tr_frameinfo = Label(root, bg=bgColor, text="Data Training", anchor="w",fg=txColor ,font=("Roboto 20 bold")).grid(row=0, column=0,pady=20, sticky='WENS',padx=20)
        ...
        self.tr_lmean = Label(root, bg=bgColor, text="Mean", anchor="w",font=("Roboto 12 bold") , fg=txColor).grid(row=1, column=0, sticky='WENS',padx=20)

        self.tr_meanR = Label(root, bg=bgColor, text="R : 12345678910", anchor="w",font=("Roboto 10 bold") , fg=txColor)
        self.tr_meanR.grid(row=2, column=0, sticky='WENS',padx=20)
        self.tr_meanG = Label(root, bg=bgColor, text="G : 1234567", anchor="w",font=("Roboto 10 bold"), fg=txColor)
        self.tr_meanG.grid(row=3, column=0, sticky='WENS',padx=20)
        self.tr_meanB = Label(root, bg=bgColor, text="B : 12345678910", anchor="w",font=("Roboto 10 bold"), fg=txColor)
        self.tr_meanB.grid(row=4, column=0, sticky='WENS',padx=20)

        self.tr_lmean = Label(root, bg=bgColor, text="Standar Deviasi", anchor="w",font=("Roboto 12 bold"), fg=txColor).grid(row=1, column=1, sticky='WENS',padx=20)
        self.tr_stdR = Label(root, bg=bgColor, text="R : 12345678910", anchor="w",font=("Roboto 10 bold"), fg=txColor)
        self.tr_stdR.grid(row=2, column=1, sticky='WENS',padx=20)
        self.tr_stdG = Label(root, bg=bgColor, text="G : 12310", anchor="w",font=("Roboto 10 bold"), fg=txColor)
        self.tr_stdG.grid(row=3, column=1, sticky='WENS',padx=20)
        self.tr_stdB = Label(root, bg=bgColor, text="B : 12345678910", anchor="w",font=("Roboto 10 bold"), fg=txColor)
        self.tr_stdB.grid(row=4, column=1, sticky='WENS',padx=20)

        self.tr_llevel = Label(root, bg=bgColor, text="Level :",anchor="w",font=("Roboto 12 bold"), fg=txColor).grid(row=5, column=0, sticky='WENS',padx=20)
        ...
        self.tr_ilevel.grid(row=5, column=1, sticky='WENS',padx=20)

        self.ketwaktu = ['pagi', 'siang', 'sore']

        self.tr_varwaktu = "pagi"

        self.tr_lwaktu = Label(root, bg=bgColor, text="Waktu :",anchor="w",font=("Roboto 12 bold"), fg=txColor).grid(row=6, column=0, sticky='WENS',padx=20)
        self.tr_iwaktu = Label(root, bg=bgColor, text="(kosong)",anchor="w",font=("Roboto 10 bold"), fg=txColor)
        self.tr_iwaktu.grid(row=6, column=1, sticky='WENS',padx=20)

        self.tr_listbox = Listbox(root,bg="#36393F",relief=FLAT,fg="white",selectbackground="#43B581",activestyle="none",font=("Roboto 10 bold"))
        ...
        self.update_tr_info(PadiController().index_tr()[0]['id'])
