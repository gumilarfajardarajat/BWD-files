...
class AddTesting:
    def __init__(self,dmroot):
        ...
        self.path = ""
        label = Label(root, text="TAMBAH DATA TESTING", font=("Roboto 11 bold"), anchor="w").grid(row=0, column=0,sticky="WENS", columnspan=3)
    ...
    def savedata(self,dmroot,root):
        ...
        DisplayMain(dmroot).lbvalts["text"] = len(PadiController().index_ts())
        root.destroy()
